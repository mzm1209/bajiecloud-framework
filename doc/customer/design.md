...
(
    ...
    `source_level`    VARCHAR(32) DEFAULT NULL COMMENT '来源等级 A B C',
    `source_point`    VARCHAR(32) DEFAULT NULL COMMENT '来源评分',
    `mobile`          VARCHAR(64)          DEFAULT NULL COMMENT '手机号（加密存储）',
    `email`           VARCHAR(128)         DEFAULT NULL COMMENT '邮箱（加密存储）',
    `wechat_id`       VARCHAR(128)         DEFAULT NULL COMMENT '微信ID',
    `wechat_mobile`   VARCHAR(64)          DEFAULT NULL COMMENT '微信手机号（加密存储）',
    ...
    `member_level`    TINYINT(2)           DEFAULT 0 COMMENT ' 会员等级：1-普通会员，2-高级会员，3-VIP会员 ',
    ...
    `last_source`     VARCHAR(32)          DEFAULT NULL COMMENT '最近一次来源',
