package com.bajie.cloud.common.web.cloud.utils.object;
...
import com.bajie.cloud.common.web.pojo.PageParam;
import com.bajie.cloud.common.web.pojo.SortablePageParam;
import com.bajie.cloud.common.web.pojo.SortingField;
...
public class PageUtils {
  ...
  private static final Object[] ORDER_TYPES = new String[]{SortingField.ORDER_ASC,
  ...
  public static <T> SortingField buildSortingField(Func1<T, ?> func, String order) {
    Assert.isTrue(ArrayUtil.contains(ORDER_TYPES, order),
